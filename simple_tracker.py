...
class GenerateReport:
    ...
    def get_best_item(self):
        try:
            return sorted(self.data, key=lambda k: k['price'])[0]#for sorting the price in ascending order
...
class AmazonAPI:
    def __init__(self, search_term, filters, base_url, currency):
        ...
        self.currency = currency
        self.price_filter = f"&rh=p_36%3A{filters['min']}00-{filters['max']}00"#for the price filtering
